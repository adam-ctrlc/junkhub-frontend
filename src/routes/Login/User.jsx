    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-gray-50 p-4 font-sans">
      <div className="w-full max-w-5xl bg-white rounded-3xl shadow-xl overflow-hidden flex flex-col md:flex-row min-h-[600px]">
        ...
        <div className="w-full md:w-5/12 bg-[#FCD34D] p-12 flex flex-col justify-between relative overflow-hidden">
          ...
          <button
            onClick={() => navigate("/")}
            className="absolute top-8 left-8 z-20 p-2 bg-white/20 hover:bg-white/30 rounded-full transition-colors text-gray-900"
          >
            <ArrowLeft size={24} />
          </button>
          ...
          <div className="relative z-10 mt-8">
            ...
            <p className="text-lg text-gray-800 font-medium leading-relaxed">
              Log in with your credentials to access your account and manage
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-[#FCD34D] focus:ring-2 focus:ring-[#FCD34D]/20 outline-none transition-all bg-gray-50 focus:bg-white"
                  required
                />
              </div>
              ...
              <div className="flex items-center justify-between text-sm">
                <label className="flex items-center gap-2 cursor-pointer group">
                  <input
                    type="checkbox"
                    className="w-4 h-4 rounded border-gray-300 text-[#FCD34D] focus:ring-[#FCD34D]"
                  />
                ...
                <Link
                  ...
                  className="font-semibold text-[#F59E0B] hover:text-[#D97706] hover:underline"
                >
                  Forgot Password?
                </Link>
              </div>
