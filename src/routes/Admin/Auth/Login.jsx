  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-gray-50 p-4 font-sans">
      <div className="w-full max-w-5xl bg-white rounded-3xl shadow-xl overflow-hidden flex flex-col md:flex-row min-h-[600px]">
        ...
        <div className="w-full md:w-5/12 bg-blue-600 p-12 flex flex-col justify-between relative overflow-hidden">
          ...
          <div className="relative z-10 flex items-center gap-3 mt-12">
            ...
            <span className="text-2xl font-bold tracking-tight text-white">
              Admin<span className="font-extrabold">Portal</span>
            </span>
          </div>
          ...
          <div className="relative z-10 mt-8">
            ...
            <p className="text-lg text-blue-50 font-medium leading-relaxed">
              Log in with your administrator credentials to manage users,
              owners, and products.
            </p>
          </div>
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 outline-none transition-all bg-gray-50 focus:bg-white"
                  required
                />
              </div>
